module "aws_cognito_user_pool_complete_example" {
  ...
  clients = [
...

    {
      ...
      callback_urls                        = ["https://www.flipkart.com/"]
      default_redirect_uri                 = "https://www.flipkart.com/"
    ...
    # ,
    # {https://cms-domain.auth.us-east-1.amazoncognito.com
    #   allowed_oauth_flows                  = []
  ...
  identity_providers = [
    {
      ...
      provider_details = {
        ...
        client_id                     = "215026885650-tvdcvdofh6qpkpvi53bmv0kld09qjdtm.apps.googleusercontent.com"
        client_secret                 = "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"
...
resource "aws_cognito_identity_provider" "saml_provider" {
  user_pool_id   = module.aws_cognito_user_pool_complete_example.id
  provider_name = "Auth0"
  provider_type = "SAML"
  provider_details = {
    "MetadataURL" = "https://dev-dkq0ty7zzr1pytuu.us.auth0.com/samlp/metadata/joRYuxRo455anbfi5D7nA51EtpVZSxji"
  }
  attribute_mapping = {
